...
// used to generate this class and read the Tree.
   ...
   if (tree == 0) {
     TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("~carrillo/eos/cms/store/user/jtao/HggAna_legacy_paper_v5/Higgs8TeVForHLT/-folder-/datastore/Higgs8TeVForHLT/-folder-/-file-");
     if (!f || !f->IsOpen()) {
       f = new TFile("~carrillo/eos/cms/store/user/jtao/HggAna_legacy_paper_v5/Higgs8TeVForHLT/-folder-/datastore/Higgs8TeVForHLT/-folder-/-file-");
     }
